...
const JoinGame = (props) => {
    ...
    return <div>
        ...
        <h3 style = {{textAlign: "center"}}>Made with ❤️ by <a href = 'https://github.com/sonachoudhury' target = '_blank'>sona choudhury</a>. Subscribe to my <a href = 'https://www.youtube.com/channel/UC4TipROulhnQer4LU5g_IBA' target = '_blank'>YouTube channel</a>. Follow me on <a href = 'https://github.com/sonachoudhury' target = '_blank'>github</a>.</h3>
    </div>
}
